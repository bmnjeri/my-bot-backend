...
// ========== HMAC SECRET – MUST MATCH EXTENSION ==========
// Set this exact string as environment variable HMAC_SECRET on Render
const SECRET = process.env.HMAC_SECRET || 'BonifaceSecret123';
